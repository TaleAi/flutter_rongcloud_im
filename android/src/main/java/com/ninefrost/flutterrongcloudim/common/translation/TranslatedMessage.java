...
public class TranslatedMessage implements ITranslatedMessage {
    ...
    public Map toMap() {
        Map map = new HashMap();
        map.put("conversationType", this.conversationType == null ? "" : this.conversationType.getValue());
        map.put("targetId", this.targetId);
        map.put("messageId", this.messageId);
        map.put("messageDirection", this.messageDirection == null? "" : this.messageDirection.getValue());
        map.put("senderUserId", this.senderUserId);
        map.put("sentStatus", this.sentStatus == null ?"":this.sentStatus.getValue());
        map.put("receivedTime", this.receivedTime);
        map.put("sentTime", this.sentTime);
        map.put("objectName", this.objectName);
        map.put("content", content == null ?"":content.toMap());
